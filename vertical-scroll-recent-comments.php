...
{
	echo '<p>Vertical scroll recent comments.<br> To change the setting goto Vertical scroll recent post link under SETTING tab.';
...
function vsrc_admin_options()
{
    ...
    <a target="_blank" href='http://gopi.coolpage.biz/demo/2009/07/29/vertical-scroll-recent-comments/'>click here</a> to post suggestion or comments or how to improve this plugin.  <br /> 
    <a target="_blank" href='http://gopi.coolpage.biz/demo/2009/07/29/vertical-scroll-recent-comments/'>click here</a> to see LIVE demo.  <br /> 
    <a target="_blank" href='http://gopi.coolpage.biz/demo/2009/07/29/vertical-scroll-recent-comments/'>click here</a> To download my other plugins.  <br /> 
	<?php
